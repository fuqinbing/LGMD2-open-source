...
namespace LGMD
{
    ...
    /// References: [1] Q. Fu, C. Hu, J. Peng, F. C. Rind, S. Yue, "A Robust Collision Perception Visual Neural Network with Specific Selectivity to Darker Objects", IEEE Transactions on Cybernetics, 2019.
